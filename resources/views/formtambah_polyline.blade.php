...
<h1 class ="h3 mb-4 text-gray-800">Tambah Polyline</h1>
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-header">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route("tambahpolyline") }}" method="post"enctype="multipart/form-data" >
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="integer" class="form-control" name="coordinate2" >
                        </div>
                        <div class="form-group">
                            <label for ="coordinate3">Koordinat 3</label>
                            <input type="integer" class="form-control" name="coordinate3" >
                        </div>
                        <div class="form-group">
                            <label for ="coordinate4">Koordinat 4</label>
                            <input type="integer" class="form-control" name="coordinate4" >
                        </div>
